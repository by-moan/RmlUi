...
namespace Rml {
	...
	class DataViewAttributeIf;
	class DataViewClass;
	class DataViewChecked;
	class DataViewFor;
	class DataViewIf;
	class DataViewRml;
	class DataViewStyle;
	class DataViewVisible;
	class DataControllerEvent;
	class DataControllerValue;
	class DebuggerPlugin;
	class Decorator;
	class DecoratorConicGradient;
	class DecoratorStraightGradient;
	class DecoratorLinearGradient;
	class DecoratorNinePatch;
	class DecoratorRadialGradient;
	class DecoratorShader;
	class DecoratorText;
	class DecoratorTiledBox;
	class DecoratorTiledHorizontal;
	class DecoratorTiledImage;
	class DecoratorTiledVertical;
	...
	class ContainerBox;
	class InlineBox;
	class InlineLevelBox_Atomic;
	class InlineLevelBox_Text;
	class InlineBoxBase;
	class InlineContainer;
	class InlineLevelBox;
	class InputType;
	class InputTypeButton;
	class InputTypeCheckbox;
	class InputTypeRadio;
	...
	class RenderManager;
	class ReplacedFormattingContext;
	...
	class XMLNodeHandlerHead;
	class XMLNodeHandlerTemplate;
	class XMLNodeHandlerBody;
	class XMLNodeHandlerSelect;
	class XMLNodeHandlerTabSet;
	class XMLNodeHandlerTextArea;
	class XMLParseTools;
	...
	namespace _a_E_D {
		...
		void SearchNavigationTarget(SearchNavigationResult& best_result, Element* element, NavigationSearchDirection direction,const Rectanglef& bounding_box, Element* exclude_element);
	}
	...
	static ColorStopList ResolveColorStops(Element* element, const float gradient_line_length, const float soft_spacing,const ColorStopList& unresolved_stops);
	...
	*/
	#ifdef JSSYNTAX_CPP
		std::shared_ptr<int> MClickEventListenersIndex = std::make_shared<int>(0);
	#endif
	class RMLUICORE_API Element : public ScriptInterface, public EnableObserverPtr<Element> {
		...
		#pragma region friend HTML Elements
		friend class ::HTMLBaseElement;
		#pragma endregion
		
		friend Rml::BlockContainer;
		friend Rml::BlockFormattingContext;
		friend Rml::ComputedValues;
		friend class Rml::AttributeManager;
		friend class Rml::BoxShadowCache;
		friend class Rml::Context;
		friend Rml::ColorStopList;
		friend class Rml::DataControllerEvent;
		friend class Rml::DataControllerValue;
		friend class Rml::DataModel;
		friend class Rml::DataView;
		friend class Rml::DataViewAttribute;
		friend class Rml::DataViewAttributeIf;
		friend class Rml::DataViewClass;
		friend class Rml::DataViewChecked;
		friend class Rml::DataViewFor;
		friend class Rml::DataViewIf;
		friend class Rml::DataViewRml;
		friend class Rml::DataViewStyle;
		friend class Rml::DataViewVisible;
		friend class Rml::Debugger::DebuggerPlugin;
		friend class Rml::Debugger::ElementContextHook;
		friend class Rml::Debugger::ElementDataModels;
		friend class Rml::Debugger::ElementInfo;
		friend class Rml::Debugger::ElementLog;
		friend class Rml::DecoratorConicGradient;
		friend class Rml::DecoratorStraightGradient;
		friend class Rml::DecoratorLinearGradient;
		friend class Rml::DecoratorNinePatch;
		friend class Rml::DecoratorRadialGradient;
		friend class Rml::DecoratorShader;
		friend class Rml::DecoratorText;
		friend class Rml::DecoratorTiledBox;
		friend class Rml::DecoratorTiledHorizontal;
		friend class Rml::DecoratorTiledImage;
		friend class Rml::DecoratorTiledVertical;
		friend class Rml::ElementBackgroundBorder;
		friend class Rml::ElementDocument;
		friend class Rml::ElementEffects;
		friend class Rml::ElementForm;
		friend class Rml::ElementFormControl;
		friend class Rml::ElementFormControlInput;
		friend class Rml::ElementFormControlSelect;
		friend class Rml::ElementFormControlTextArea;
		friend class Rml::ElementImage;
		friend class Rml::ElementHandle;
		friend class Rml::ElementHandleTargetData;
		friend class Rml::ElementInstancerElement;
		friend class Rml::ElementLabel;
		friend class Rml::ElementProgress;
		friend class Rml::ElementStyle;
		friend class Rml::ElementTabSet;
		friend class Rml::ElementText;
		friend class Rml::ElementUtilities;
		friend class Rml::Event;
		friend class Rml::EventDispatcher;
		friend class Rml::Factory;
		friend class Rml::FilterBasic;
		friend class Rml::FilterBlur;
		friend class Rml::FilterDropShadow;
		friend class Rml::FlexContainer;
		friend class Rml::FlexFormattingContext;
		friend class Rml::FloatedBoxSpace;
		friend class Rml::FormattingContext;
		friend class Rml::GeometryBoxShadow;
		friend class Rml::ContainerBox;
		friend class Rml::InlineBox;
		friend class Rml::InlineLevelBox_Atomic;
		friend class Rml::InlineLevelBox_Text;
		friend class Rml::InlineBoxBase;
		friend class Rml::InlineContainer;
		friend class Rml::InlineLevelBox;
		friend class Rml::InputTypeButton;
		friend class Rml::InputTypeCheckbox;
		friend class Rml::InputTypeSubmit;
		friend class Rml::InputType;
		friend class Rml::InputTypeRadio;
		friend class Rml::InputTypeText;
		friend class Rml::ReplacedBox;
		friend class Rml::ReplacedFormattingContext;
		friend class Rml::ScrollController;
		friend class Rml::StyleManager;
		friend class Rml::StyleManager_Style;
		friend class Rml::StyleSheet;
		friend class Rml::StyleSheetNode;
		friend class Rml::TableGrid;
		friend class Rml::TableFormattingContext;
		friend class Rml::TableWrapper;
		friend class Rml::Template;
		friend class Rml::LayoutEngine;
		friend class Rml::LayoutDetails;
		friend class Rml::ElementScroll;
		friend class Rml::WidgetScroll;
		friend class Rml::WidgetDropDown;
		friend class Rml::WidgetSlider;
		friend class Rml::WidgetTextInput;
		friend class Rml::WidgetTextInputSingleLine;
		friend class Rml::XMLNodeHandlerBody;
		friend class Rml::XMLNodeHandlerDefault;
		friend class Rml::XMLNodeHandlerHead;
		friend class Rml::XMLNodeHandlerSelect;
		friend class Rml::XMLNodeHandlerTabSet;
		friend class Rml::XMLNodeHandlerTemplate;
		friend class Rml::XMLNodeHandlerTextArea;
		friend class Rml::XMLParser;
		friend class Rml::XMLParseTools;

		friend struct Rml::DebugDumpLayoutTree;

		friend bool operator<(const StackingContextChild& lhs, const StackingContextChild& rhs);
		friend Element* QuerySelectorMatchRecursive(const StyleSheetNodeListRaw& nodes, Element* element, Element* scope);
		friend void QuerySelectorAllMatchRecursive(ElementList& matching_elements, const StyleSheetNodeListRaw& nodes, Element* element, Element* scope);
		friend int Lua::ElementAddEventListener(lua_State* L, Element* obj);
		friend int Lua::ElementAppendChild(lua_State* L, Element* obj);
		friend Element* FindFocusElement(Element* element);
		friend NumericValue InterpolateNumericValue(NumericValue v0, NumericValue v1, float alpha, Element& element, const PropertyDefinition* definition);
		friend Property InterpolateProperties(const Property& p0, const Property& p1, float alpha, Element& element, const PropertyDefinition* definition);
		friend ColorStopList ResolveColorStops(Element* element, const float gradient_line_length, const float soft_spacing, const ColorStopList& unresolved_stops);
		friend RMLUICORE_API void Rml::ReleaseFontResources();
		friend _a_E_D::CanFocus _a_E_D::CanFocusElement(Element* element);
		friend bool _a_E_D::IsScrollContainer(Element* element);
		friend void _a_E_D::SearchNavigationTarget(Rml::_a_E_D::SearchNavigationResult& best_result, Element* element, NavigationSearchDirection direction,const Rectanglef& bounding_box, Element* exclude_element);
		friend float ComputeLength(NumericValue value, Element* element);
		friend TextOverflowResolved ResolveTextOverflow(Element* parent, FontFaceHandle font_face_handle);
		friend void LogMissingFontFace(Element* element);
		friend bool IsTextElement(const Element* element);
		friend bool IsSelectorApplicable(const Element* element, const StructuralSelector& selector, const Element* scope);
		friend float ResolveWidth(NumericValue value, Element& e) noexcept;
		friend float ResolveHeight(NumericValue value, Element& e) noexcept;
		friend float ResolveLength(NumericValue value, Element& e) noexcept;
		friend Element* TagMatchRecursive(const StringList& tags, Element* element);
		friend void LogUnexpectedFlowElement(Element* element, Style::Display display);
		...
		*/
		...
		bool Animate(PropertyId id, const Property& target_value, float duration, Tween tween = Tween{}, int num_iterations = 1,bool alternate_direction = true, float delay = 0.0f, const Property* start_value = nullptr);
